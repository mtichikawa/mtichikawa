...
| T4 | [trading-backtester](https://github.com/mtichikawa/trading-backtester) | pandas · Sharpe · Sortino · drawdown · signal feedback loop · 72/72 tests | 🟢 Complete |
...
**Trading Systems:** ccxt · Kraken API · OHLCV pipelines · mplfinance · technical indicators · FinBERT sentiment · pandas backtesting · signal parameter optimization
